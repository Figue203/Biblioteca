...
<head>
     ...
     <title>Registration Form</title>
      ...
      <style>
      body{
	 background-image:url(https://wallup.net/wp-content/uploads/2018/03/19/554789-music-vintage-audio_cassete-Sting-748x482.jpg);
...
<body>
 <div class="container">
 <!---heading---->
     <header class="heading">Crear Cuenta</header><hr></hr>
	<!---Form starting---->
	<div class="row ">
	 <!--- For Name---->
         <div class="col-sm-12">
